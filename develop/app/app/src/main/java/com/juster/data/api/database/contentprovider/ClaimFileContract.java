 ...
 */
public class ClaimFileContract {

    private ClaimFileContract() {
    ...
    public static class ActivityFile implements BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.exzeo.adjustermate.provider." + ActivityFile.TABLE_NAME;
        /**
         * MIME type for individual entries.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.exzeo.adjustermate.provider." + ActivityFile.TABLE_NAME;
         ...
         */
        //TODO: Deepak correct diary file names
...
/*        public static final String COLUMN_ACTIVITY_FILE_LOCAL_PATH = "act_file_storage_path";
        public static final String COLUMN_ACTIVITY_FILE_THUMB_LOCAL_PATH = "act_file_thumb_storage_path";*/
